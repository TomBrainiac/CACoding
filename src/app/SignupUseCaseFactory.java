...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createUserClearUseCase(viewManagerModel, clearViewModel, signupViewModel, clearUserDataAccessObject);
    ...
    private static ClearController createUserClearUseCase(ViewManagerModel viewManagerModel, ClearViewModel clearViewModel, SignupViewModel signupViewModel, ClearUserDataAccessInterface userDataAccessObject) throws IOException {
        ...
        ClearInteractor clearInteractor = new ClearInteractor(clearOutputBoundary, userDataAccessObject);
